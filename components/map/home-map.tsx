...
export default function MapChart() {
  ...
  const formatJsonData = (dscInput: any = {}, cscaInput: any = {}, countryNames: any = {}): any => {
  ...
  const fetchJsonInfo = async () => {
    try {
      ...
      const dscFetchData = await fetch('https://raw.githubusercontent.com/zk-passport/proof-of-passport/dev/registry/outputs/dsc_formatted.json');
      const dscData = await dscFetchData.json();
      
      // Top-level Certificates (CSCA) issued by each country
      const cscaFetchData = await fetch('https://raw.githubusercontent.com/zk-passport/proof-of-passport/dev/registry/outputs/csca_formatted.json');
      ...
      const allCountriesData = formatJsonData({ ...dscData }, {...cscaData}, countryNames);
